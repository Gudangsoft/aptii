...
} elseif ($_instance->childHasBeenRendered('s5jmQs6')) {
    $componentId = $_instance->getRenderedChildComponentId('s5jmQs6');
    $componentTag = $_instance->getRenderedChildComponentTagName('s5jmQs6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('s5jmQs6');
} else {
    $response = \Livewire\Livewire::mount('prosiding.certificate');
    $html = $response->html();
    $_instance->logRenderedChild('s5jmQs6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/prosiding/certificate/index.blade.php ENDPATH**/ ?>