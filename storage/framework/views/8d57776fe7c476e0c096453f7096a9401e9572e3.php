<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="<?php echo e(request()->routeIs('managers.index') ? 'active' : ''); ?> nav-item"><a class="d-flex align-items-center" href="<?php echo e(route('managers.index')); ?>"><i data-feather="user-check"></i><span class="menu-title text-truncate" data-i18n="Pages">Pengurus</span></a>
            </li>
            ...
            <li class="<?php echo e(request()->routeIs('menu.index') ? 'active' : ''); ?> nav-item"><a class="d-flex align-items-center" href="<?php echo e(route('menu.index')); ?>"><i data-feather="list"></i><span class="menu-title text-truncate" data-i18n="Configuration">Menu</span></a>
            </li>
