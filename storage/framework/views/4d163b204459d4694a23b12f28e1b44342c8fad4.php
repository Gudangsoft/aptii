...
} elseif ($_instance->childHasBeenRendered('yC7mMwC')) {
    $componentId = $_instance->getRenderedChildComponentId('yC7mMwC');
    $componentTag = $_instance->getRenderedChildComponentTagName('yC7mMwC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yC7mMwC');
} else {
    $response = \Livewire\Livewire::mount('prosiding.seminar');
    $html = $response->html();
    $_instance->logRenderedChild('yC7mMwC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/prosiding/seminar/index.blade.php ENDPATH**/ ?>