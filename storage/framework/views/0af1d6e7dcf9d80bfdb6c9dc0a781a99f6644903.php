                ...
                <div class="row" id="basic-table">
                    <div class="col-12">
                        <div class="card p-1">
                            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('event.event-table')->html();
} elseif ($_instance->childHasBeenRendered('WBnZvXh')) {
    $componentId = $_instance->getRenderedChildComponentId('WBnZvXh');
    $componentTag = $_instance->getRenderedChildComponentTagName('WBnZvXh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WBnZvXh');
} else {
    $response = \Livewire\Livewire::mount('event.event-table');
    $html = $response->html();
    $_instance->logRenderedChild('WBnZvXh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/event/index.blade.php ENDPATH**/ ?>