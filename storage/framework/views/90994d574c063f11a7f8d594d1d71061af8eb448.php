...
} elseif ($_instance->childHasBeenRendered('ZXvbmLJ')) {
    $componentId = $_instance->getRenderedChildComponentId('ZXvbmLJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZXvbmLJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZXvbmLJ');
} else {
    $response = \Livewire\Livewire::mount('prosiding.info-prosiding');
    $html = $response->html();
    $_instance->logRenderedChild('ZXvbmLJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <!--/ Blog List Items -->
...
<?php endif; ?>
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/admin/prosiding/info/index.blade.php ENDPATH**/ ?>