                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Form -->
                                <form action="<?php echo e(route('articles.store')); ?>" method="POST" enctype="multipart/form-data" class="mt-2">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                <label for="blog-edit-title">Title</label>
                                                <input type="text" name="title" id="title" value="<?php echo e(old('title')); ?>" class="form-control" onInput="edValueKeyPress()">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            <textarea name="content" class="ckeditor" id="" cols="30" rows="10"><?php echo e(old('content')); ?></textarea>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
...
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/article/create.blade.php ENDPATH**/ ?>