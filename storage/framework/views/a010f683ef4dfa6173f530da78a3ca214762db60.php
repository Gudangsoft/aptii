                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 col-sm-12">
                                <a href="<?php echo e(route('certificate.create')); ?>" class="btn-icon btn btn-primary btn-round"><i data-feather="plus-circle"></i> Tambah Sertifikat</a>
                            </div>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($row->model == 'naskah'): ?>
                                                <span class="badge badge-light-primary"><?php echo e($row->getNaskah->judul); ?></span>
                                            <?php else: ?>
                                                <span class="badge badge-light-danger"><?php echo e($row->getEvent->judul); ?></span>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="/storage/files/certificate/<?php echo e($row->file); ?>">Detail</a>
                                                    <a class="dropdown-item" href="<?php echo e(route('certificate.edit', $row->id)); ?>">Edit</a>
...
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/livewire/prosiding/certificate.blade.php ENDPATH**/ ?>