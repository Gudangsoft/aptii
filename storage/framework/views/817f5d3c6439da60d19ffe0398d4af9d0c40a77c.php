...
} elseif ($_instance->childHasBeenRendered('HJvWBwe')) {
    $componentId = $_instance->getRenderedChildComponentId('HJvWBwe');
    $componentTag = $_instance->getRenderedChildComponentTagName('HJvWBwe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HJvWBwe');
} else {
    $response = \Livewire\Livewire::mount('prosiding.certificate-participant');
    $html = $response->html();
    $_instance->logRenderedChild('HJvWBwe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/prosiding/certificate/public-certificate.blade.php ENDPATH**/ ?>