...
} elseif ($_instance->childHasBeenRendered('DdWAvuy')) {
    $componentId = $_instance->getRenderedChildComponentId('DdWAvuy');
    $componentTag = $_instance->getRenderedChildComponentTagName('DdWAvuy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DdWAvuy');
} else {
    $response = \Livewire\Livewire::mount('prosiding.link');
    $html = $response->html();
    $_instance->logRenderedChild('DdWAvuy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php endif; ?>
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/admin/prosiding/link/index.blade.php ENDPATH**/ ?>