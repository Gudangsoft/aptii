...
<?php $component->withAttributes([]); ?>
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('setting.permission')->html();
} elseif ($_instance->childHasBeenRendered('6HONByz')) {
    $componentId = $_instance->getRenderedChildComponentId('6HONByz');
    $componentTag = $_instance->getRenderedChildComponentTagName('6HONByz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6HONByz');
} else {
    $response = \Livewire\Livewire::mount('setting.permission');
    $html = $response->html();
    $_instance->logRenderedChild('6HONByz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php endif; ?>
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/admin/settings/permission.blade.php ENDPATH**/ ?>