...
} elseif ($_instance->childHasBeenRendered('sUTW6Ao')) {
    $componentId = $_instance->getRenderedChildComponentId('sUTW6Ao');
    $componentTag = $_instance->getRenderedChildComponentTagName('sUTW6Ao');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sUTW6Ao');
} else {
    $response = \Livewire\Livewire::mount('user-trashed', []);
    $html = $response->html();
    $_instance->logRenderedChild('sUTW6Ao', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php endif; ?>
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/admin/users/trashed.blade.php ENDPATH**/ ?>