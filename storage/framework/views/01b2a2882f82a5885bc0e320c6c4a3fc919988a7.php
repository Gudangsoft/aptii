...
} elseif ($_instance->childHasBeenRendered('ooJC6Nw')) {
    $componentId = $_instance->getRenderedChildComponentId('ooJC6Nw');
    $componentTag = $_instance->getRenderedChildComponentTagName('ooJC6Nw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ooJC6Nw');
} else {
    $response = \Livewire\Livewire::mount('prosiding.certificate');
    $html = $response->html();
    $_instance->logRenderedChild('ooJC6Nw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/admin/prosiding/certificate/index.blade.php ENDPATH**/ ?>