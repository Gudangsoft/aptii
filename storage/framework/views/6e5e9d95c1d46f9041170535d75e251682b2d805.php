                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="url" name="kta_anggota" placeholder="https://" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label><h5>Link SK Anggota</h5></label>
                                                                <input type="url" name="sk_anggota" placeholder="https://" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php endif; ?>
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/admin/asosiasi/certificate/create.blade.php ENDPATH**/ ?>