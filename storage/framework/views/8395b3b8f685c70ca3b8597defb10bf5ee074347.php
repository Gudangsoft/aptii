...
} elseif ($_instance->childHasBeenRendered('VyYyrHj')) {
    $componentId = $_instance->getRenderedChildComponentId('VyYyrHj');
    $componentTag = $_instance->getRenderedChildComponentTagName('VyYyrHj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VyYyrHj');
} else {
    $response = \Livewire\Livewire::mount('prosiding.template-prosiding');
    $html = $response->html();
    $_instance->logRenderedChild('VyYyrHj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
