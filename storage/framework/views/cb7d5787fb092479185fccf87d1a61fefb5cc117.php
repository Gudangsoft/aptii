                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="<?php echo e(route('agenda.index')); ?>">Agenda</a>
                                    </li>
                        ...
                        <div class="card p-1">
                            <div class="content-body">
                                <div class="row" id="basic-table">
                                    <div class="col-12">
                                        <div class="card">
                                            <form action="<?php echo e(route('agenda.store')); ?>" method="POST" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label><h5>Judul</h5></label>
                                                        <input type="text" name="title" class="form-control" placeholder="Judul Agenda" value="<?php echo e(old('title')); ?>" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label><h5>Keterangan</h5></label>
                                                        <textarea name="description" class="ckeditor" id="" cols="30" rows="10"><?php echo e(old('keterangan')); ?></textarea>
                                                    </div>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/prosiding/agenda/create.blade.php ENDPATH**/ ?>