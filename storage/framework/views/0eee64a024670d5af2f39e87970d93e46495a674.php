...
} elseif ($_instance->childHasBeenRendered('YAHa26E')) {
    $componentId = $_instance->getRenderedChildComponentId('YAHa26E');
    $componentTag = $_instance->getRenderedChildComponentTagName('YAHa26E');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YAHa26E');
} else {
    $response = \Livewire\Livewire::mount('user-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('YAHa26E', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></livewire:user-table>
                    </div>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/users/index.blade.php ENDPATH**/ ?>