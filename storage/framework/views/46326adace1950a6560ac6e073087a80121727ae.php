...
} elseif ($_instance->childHasBeenRendered('noFhEKn')) {
    $componentId = $_instance->getRenderedChildComponentId('noFhEKn');
    $componentTag = $_instance->getRenderedChildComponentTagName('noFhEKn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('noFhEKn');
} else {
    $response = \Livewire\Livewire::mount('prosiding.agenda');
    $html = $response->html();
    $_instance->logRenderedChild('noFhEKn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/prosiding/agenda/index.blade.php ENDPATH**/ ?>