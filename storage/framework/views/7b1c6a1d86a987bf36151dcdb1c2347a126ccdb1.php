...
} elseif ($_instance->childHasBeenRendered('HO46kfA')) {
    $componentId = $_instance->getRenderedChildComponentId('HO46kfA');
    $componentTag = $_instance->getRenderedChildComponentTagName('HO46kfA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HO46kfA');
} else {
    $response = \Livewire\Livewire::mount('articles-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('HO46kfA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
...
<?php endif; ?>
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/admin/article/index.blade.php ENDPATH**/ ?>