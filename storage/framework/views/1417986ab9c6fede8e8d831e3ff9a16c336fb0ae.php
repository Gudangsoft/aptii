...
} elseif ($_instance->childHasBeenRendered('hrStS4c')) {
    $componentId = $_instance->getRenderedChildComponentId('hrStS4c');
    $componentTag = $_instance->getRenderedChildComponentTagName('hrStS4c');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hrStS4c');
} else {
    $response = \Livewire\Livewire::mount('prosiding.customer-care');
    $html = $response->html();
    $_instance->logRenderedChild('hrStS4c', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/prosiding/cs/index.blade.php ENDPATH**/ ?>