            ...
            <div class="col-md-8">
                <div class="blog-read">
                    ...
                    <div class="post-text">
                        ...
                        <p>
                            <b>Waktu</b><br>
                            <span><?php echo e(\Carbon\Carbon::parse($data->date_start)->isoFormat('dddd, D MMMM Y')); ?></span> - <span><?php echo e(\Carbon\Carbon::parse($data->date_end)->isoFormat('dddd, D MMMM Y')); ?> </span><br>
                            <span>Pukul</span>&nbsp;&nbsp;<span><?php echo e(\Carbon\Carbon::parse($data->date_start)->format('h:i')); ?> - <?php echo e(\Carbon\Carbon::parse($data->date_end)->format('h:i')); ?> </span>
                        </p>
                        <p>LINK : <?php echo e($data->link ?? 'tidak tersedia'); ?></p>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/frontend/events/detail.blade.php ENDPATH**/ ?>