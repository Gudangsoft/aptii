                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="<?php echo e(route('prosiding.pembayaran')); ?>">Pembayaran</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('hA4ofyp')) {
    $componentId = $_instance->getRenderedChildComponentId('hA4ofyp');
    $componentTag = $_instance->getRenderedChildComponentTagName('hA4ofyp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hA4ofyp');
} else {
    $response = \Livewire\Livewire::mount('prosiding.data-pembayaran');
    $html = $response->html();
    $_instance->logRenderedChild('hA4ofyp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/prosiding/pembayaran.blade.php ENDPATH**/ ?>