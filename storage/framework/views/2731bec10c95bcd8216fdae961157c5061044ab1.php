    ...
    <div class="row">
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-4 col-12">
                <div class="card">
                    <a href="<?php echo e(route('asosiasi.seminar-detail', $item->slug)); ?>">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="<?php echo e(route('asosiasi.seminar-detail', $item->slug)); ?>" class="blog-title-truncate text-body-heading"><?php echo e($item->judul); ?></a>
                        </h4>
                        <div class="media">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="<?php echo e(route('asosiasi.seminar-detail', $item->slug)); ?>" class="font-weight-bold">Baca Detail</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/livewire/prosiding/seminar.blade.php ENDPATH**/ ?>