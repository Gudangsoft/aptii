...
} elseif ($_instance->childHasBeenRendered('EQbi8FP')) {
    $componentId = $_instance->getRenderedChildComponentId('EQbi8FP');
    $componentTag = $_instance->getRenderedChildComponentTagName('EQbi8FP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EQbi8FP');
} else {
    $response = \Livewire\Livewire::mount('prosiding.certificate-participant');
    $html = $response->html();
    $_instance->logRenderedChild('EQbi8FP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/admin/prosiding/certificate/public-certificate.blade.php ENDPATH**/ ?>