...
} elseif ($_instance->childHasBeenRendered('QIHtGYP')) {
    $componentId = $_instance->getRenderedChildComponentId('QIHtGYP');
    $componentTag = $_instance->getRenderedChildComponentTagName('QIHtGYP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QIHtGYP');
} else {
    $response = \Livewire\Livewire::mount('prosiding.bidang-ilmu');
    $html = $response->html();
    $_instance->logRenderedChild('QIHtGYP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php endif; ?>
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/admin/asosiasi/bidang-ilmu/index.blade.php ENDPATH**/ ?>