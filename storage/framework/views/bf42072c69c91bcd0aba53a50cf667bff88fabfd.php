                    ...
                    <?php if(is_array($element)): ?>
                        <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page == $paginator->currentPage()): ?>
                                <li class="active" wire:key="paginator-<?php echo e($paginator->getPageName()); ?>-<?php echo e($this->numberOfPaginatorsRendered[$paginator->getPageName()]); ?>-page-<?php echo e($page); ?>" aria-current="page"><span class="active"><?php echo e($page); ?></span></li>
                            <?php else: ?>
...
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/vendor/livewire-tables/specific/bootstrap-4/pagination.blade.php ENDPATH**/ ?>