        ...
        <div class="row justify-content-center">
                ...
                <div class="course-grid course-style-3">
                    <div class="course-header">
                        <div class="course-thumb">
                            <img src="<?php echo e(asset('frontend')); ?>/images/course/img_01.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                        ...
                        <div class="course-meta-info">
                            <div class="d-flex align-items-center">
                                <div class="author me-3">
                                    <img src="<?php echo e(asset('frontend')); ?>/images/course/course-2.jpg" alt="" class="img-fluid">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="course-grid course-style-3">
                    <div class="course-header">
                        <div class="course-thumb">
                            <img src="<?php echo e(asset('frontend')); ?>/images/course/img_02.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="course-grid course-style-3">
                    <div class="course-header">
                        <div class="course-thumb">
                            <img src="<?php echo e(asset('frontend')); ?>/images/course/img_03.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
...
<?php /**PATH /home/jarwonozt/Desktop/WEB/aptii/data/resources/views/client/sections/posts.blade.php ENDPATH**/ ?>