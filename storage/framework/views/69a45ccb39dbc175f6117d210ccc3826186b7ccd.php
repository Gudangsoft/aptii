                ...
                <section class="modern-vertical-wizard">
                    <div class="bs-stepper vertical wizard-modern modern-vertical-wizard-example">
                        ...
                        <div class="bs-stepper-content">
                            <form action="<?php echo e(route('configuration.update', 1)); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div id="account-details-vertical-modern" class="content">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" value="<?php echo e($data->name ? $data->name : old('name')); ?>" id="vertical-modern-username" class="form-control" name="name" placeholder="Jarwonotech Cafe" />
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="vertical-modern-username">SEO Tags</label>
                                            <input type="text" value="<?php echo e($data->tags ? $data->tags : old('tags')); ?>" id="vertical-modern-username" class="form-control" name="tags" placeholder="startup, company, trendy" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group form-password-toggle col-md-12">
                                            ...
                                            <textarea name="description" id="" cols="30" rows="5" class="form-control"><?php echo e($data->description ? $data->description : 'Insert your descripton web app'); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                                ...
                                                <div class="media flex-column flex-md-row">
                                                    <div class="media-body">
                                                        <?php if(isset($data->logo)): ?>
                                                            <img src="<?php echo e(asset('storage/images/logo').'/'.$data->logo); ?>" id="blog-feature-image" class="rounded mr-2 mb-1 mb-md-0 bg-secondary" alt="Blog Featured Image" />
                                                        <?php endif; ?>
                                                        <p class="my-50">
                                                            <small class="text-muted">Required 228px x 36px Image max size 2MB.</small>
                                                            <br>
                                                            <a href="javascript:void(0);" id="blog-image-text"><?php echo e($data->logo ? asset('storage/images/logo').'/'.$data->logo : 'C:\fakepath\Logo.jpg'); ?></a>
                                                        </p>
                                ...
                                <div id="personal-info-vertical-modern" class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-1">
                                            <a href="<?php echo e(route('users.create')); ?>" class="btn btn-primary btn-block">Create New User</a>
                                        </div>
                                        <div class="col-md-12 mb-1">
                                            <label>Get from data user</label>
                                            <select class="select2 form-control" name="owner_id">
                                                <?php if(isset($data)): ?>
                                                    <option value="<?php echo e($data->owner_id); ?>"><?php echo e($data->getOwner->name); ?></option>
                                                <?php endif; ?>
                                ...
                                <div id="address-step-vertical-modern" class="content">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <textarea name="address_map" id="" cols="30" rows="1" class="form-control"><?php echo $data->address_map ?? 'https://www.google.com/maps/embed?pb=...'; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="content-header">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <textarea name="address" id="" cols="30" rows="5" class="form-control"><?php echo $data->address; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <a class="btn btn-primary btn-prev">
                                ...
                                <div id="social-links-vertical-modern" class="content">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="email" id="vertical-modern-email" class="form-control" name="email" value="<?php echo e($data->email ? $data->email : old('email')); ?>" placeholder="jarwonozt@email.com" aria-label="jarwonoztr" />
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="vertical-modern-facebook">WhatsApp Number</label>
                                            <input type="number" name="whatsapp" id="vertical-modern-facebook" class="form-control" placeholder="0821234567" value="<?php echo e($data->whatsapp ? $data->whatsapp : old('whatsapp')); ?>"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="vertical-modern-twitter">Twitter</label>
                                            <input type="text" name="twitter" id="vertical-modern-twitter" class="form-control" placeholder="@myname" value="<?php echo e($data->twitter ? $data->twitter : old('twitter')); ?>"/>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="vertical-modern-facebook">Facebook</label>
                                            <input type="url" name="facebook" id="vertical-modern-facebook" class="form-control" placeholder="https://facebook.com/abc" value="<?php echo e($data->facebook ? $data->facebook : old('facebook')); ?>"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="vertical-modern-twitter">Instagram</label>
                                            <input type="text" name="instagram" id="vertical-modern-twitter" class="form-control" placeholder="@yourig" value="<?php echo e($data->instagram ? $data->instagram : old('instagram')); ?>"/>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="vertical-modern-facebook">Tiktok</label>
                                            <input type="url" name="tiktok" id="vertical-modern-facebook" class="form-control" placeholder="https://tiktok.com/abc" value="<?php echo e($data->tiktok ? $data->tiktok : old('tiktok')); ?>"/>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <a class="btn btn-primary btn-prev">
...
<script src="<?php echo e(asset('assets')); ?>/js/scripts/forms/form-wizard.js"></script>
<script>
    $(function(){
        $("#pic-form").fileinput({
            showCaption: false,
...
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/settings/configuration.blade.php ENDPATH**/ ?>