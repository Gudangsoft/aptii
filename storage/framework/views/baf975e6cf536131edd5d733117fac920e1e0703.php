...
} elseif ($_instance->childHasBeenRendered('tTa8EUD')) {
    $componentId = $_instance->getRenderedChildComponentId('tTa8EUD');
    $componentTag = $_instance->getRenderedChildComponentTagName('tTa8EUD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tTa8EUD');
} else {
    $response = \Livewire\Livewire::mount('prosiding.certificate');
    $html = $response->html();
    $_instance->logRenderedChild('tTa8EUD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
