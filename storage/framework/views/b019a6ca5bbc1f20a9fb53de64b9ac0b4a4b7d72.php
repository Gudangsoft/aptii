...
} elseif ($_instance->childHasBeenRendered('pLwmcfg')) {
    $componentId = $_instance->getRenderedChildComponentId('pLwmcfg');
    $componentTag = $_instance->getRenderedChildComponentTagName('pLwmcfg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pLwmcfg');
} else {
    $response = \Livewire\Livewire::mount('prosiding.certificate-participant');
    $html = $response->html();
    $_instance->logRenderedChild('pLwmcfg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
