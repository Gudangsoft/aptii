...
<?php $component->withAttributes([]); ?>
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('articles.index')); ?>">Articles</a>
                                    </li>
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar mr-75">
                                            <img src="<?php echo e(asset('assets')); ?>/images/portrait/small/avatar-s-9.jpg" width="38" height="38" alt="Avatar" />
                                        </div>
                                        <div class="media-body">
                                            <h6 class="mb-25"><?php echo e(auth()->user()->name); ?></h6>
                                            <p class="card-text"><?php echo e(\Carbon\Carbon::now()->format('D, d M Y')); ?></p>
                                        </div>
                                    </div>
                                    <!-- Form -->
                                    <form action="<?php echo e(route('articles.update', $data->id)); ?>" method="POST" enctype="multipart/form-data" class="mt-2">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" name="title" id="title" class="form-control" onInput="edValueKeyPress()" value="<?php echo e($data->title); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    <label for="fp-date-time">Date & Time</label>
                                                    <input type="text" name="date" id="fp-date-time" class="form-control flatpickr-date-time" value="<?php echo e($data->updated_at); ?>" placeholder="YYYY-MM-DD HH:MM" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" name="slug" id="slug" class="form-control" value="<?php echo e($data->slug); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12 mb-1">
                                                ...
                                                <select class="select2 form-control" name="category">
                                                    <?php if($currentCategory != null): ?>
                                                        <option value="<?php echo e($currentCategory->id); ?>"><?php echo e(strtoupper($currentCategory->name)); ?></option>
                                                    <?php endif; ?>
                                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($category->id); ?>"><?php echo e(strtoupper($category->name)); ?></option>
                                            ...
                                            <div class="col-12 mb-2">
                                                ...
                                                <div class="demo-inline-spacing">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customRadio1" name="type" value="0" class="custom-control-input" <?php echo e($data->type == 0 ? 'checked' : ''); ?> />
                                                    ...
                                                    <div class="custom-control custom-control-warning custom-radio">
                                                        <input type="radio" id="customRadio2" name="type" value="1" class="custom-control-input" <?php echo e($data->type == 1 ? 'checked' : ''); ?> />
                                            ...
                                            <div class="col-12 mb-2">
                                                ...
                                                <textarea name="content" class="ckeditor" id="" cols="30" rows="10"><?php echo $data->content; ?></textarea>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <select class="select2 form-control" name="tags[]" multiple>
                                                        <optgroup label="Tags">
                                                            <?php $__currentLoopData = $tagsCurrent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($tagc->id); ?>" selected><?php echo e($tagc->title); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="border rounded p-2">
                                                    ...
                                                    <div class="media flex-column flex-md-row">
                                                        <?php if($data->image != null): ?>
                                                            <img src="<?php echo e(asset(config('app.POST_MID'))); ?>/<?php echo e($data->image); ?>" id="blog-feature-image" class="rounded mr-2 mb-1 mb-md-0" width="170" height="110" alt="Blog Featured Image" />
                                                        <?php else: ?>
                                                            <img src="<?php echo e(asset('assets')); ?>/images/slider/03.jpg" id="blog-feature-image" class="rounded mr-2 mb-1 mb-md-0" width="170" height="110" alt="Blog Featured Image" />
                                                        <?php endif; ?>
                                                        <div class="media-body">
                                                            <?php if(isset($data->image)): ?>
                                                                <p class="my-50">
                                                                    <a href="javascript:void(0);" id="blog-image-text"><?php echo e($data->image ? config('app.POST_MID').'/'.$data->image : 'C:\fakepath\banner.jpg'); ?></a>
                                                                </p>
                                                            <?php endif; ?>
                                            ...
                                            <div class="col-12 mt-5">
                                                ...
                                                <a href="<?php echo e(route('articles.index')); ?>" class="btn btn-outline-secondary">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('backend/plugins/bootstrap-fileinput/css/fileinput.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets')); ?>/vendors/cropperjs/cropper.css">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets')); ?>/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets')); ?>/css/plugins/forms/form-quill-editor.css">
    ...
    <script src="<?php echo e(asset('backend/plugins/bootstrap-fileinput/js/fileinput.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/plugins/bootstrap-fileinput/themes/fa/theme.js')); ?>"></script>
    <script src="<?php echo e(asset('assets')); ?>/js/scripts/pages/page-blog-edit.js"></script>
    <script src="<?php echo e(asset('assets')); ?>/vendors/cropperjs/cropper.js"></script>
    ...
    <script src="<?php echo e(asset('assets')); ?>/js/scripts/forms/form-crop-image.js"></script>
...
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/article/edit.blade.php ENDPATH**/ ?>