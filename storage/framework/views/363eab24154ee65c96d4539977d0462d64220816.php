...
} elseif ($_instance->childHasBeenRendered('zSRuKVk')) {
    $componentId = $_instance->getRenderedChildComponentId('zSRuKVk');
    $componentTag = $_instance->getRenderedChildComponentTagName('zSRuKVk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zSRuKVk');
} else {
    $response = \Livewire\Livewire::mount('prosiding.bukti-pembayaran');
    $html = $response->html();
    $_instance->logRenderedChild('zSRuKVk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
