                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="<?php echo e(route('prosiding.upload-naskah')); ?>">Naskah</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
...
} elseif ($_instance->childHasBeenRendered('TyWXAj2')) {
    $componentId = $_instance->getRenderedChildComponentId('TyWXAj2');
    $componentTag = $_instance->getRenderedChildComponentTagName('TyWXAj2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TyWXAj2');
} else {
    $response = \Livewire\Livewire::mount('prosiding.upload-naskah');
    $html = $response->html();
    $_instance->logRenderedChild('TyWXAj2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php endif; ?>
<?php /**PATH /home/proh9171/public_html/prosiding.stpkat.ac.id/resources/views/admin/prosiding/naskah-upload.blade.php ENDPATH**/ ?>