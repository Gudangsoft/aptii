    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-7">
                    <h2 class="content-header-title float-left mb-0">Pilih Anggota</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{ route('memberships.index') }}">List Anggota</a>
                            </li>
                            <li class="breadcrumb-item active">Pilih Anggota
                            </li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <p class="card-text">
                                            ...
                                            <div class="btn-group">
                                                <button class="btn btn-secondary btn-sm dropdown-toggle" type="button" id="dropdownMenuButton6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Pilih Sebagai Anggota
                                                </button>
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton6">
                                                    <a class="dropdown-item" href="javascript:void(0);" wire:click="addMembership()">Tambahkan Anggota</a>
                                                </div>
                                            </div>
                                        </p>
                                    </th>
                            ...
                            <tbody>
                                @forelse ($data as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->company ?? 'Tidak tersedia' }}</td>
                                        <td>
                                            @if ($row->status == true)
