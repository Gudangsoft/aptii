            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Tambah Jurnal</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Tambah Jurnal
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if($errors->any())
                                        ...
                                        @endforeach
                                    @endif
                                    <form action="{{ route('journal_collab.store') }}" method="POST" enctype="multipart/form-data" class="mt-2">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-8 col-sm-12 col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-group mb-2">
                                                            <h5>Afiliasi</h3>
                                                            <input type="text" name="afiliasi" id="institution" value="{{ old('afiliasi') }}" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-group mb-2">
                                                            <h5>Link Jurnal</h3>
                                                            <input type="url" name="link_journal" id="link_journal" value="{{ old('link_journal') }}" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-group mb-2">
