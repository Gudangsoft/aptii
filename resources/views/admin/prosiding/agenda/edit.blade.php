            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Edit Agenda</h2>
                                            ...
                                            <form action="{{ route('agenda.update') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" class="form-control" placeholder="Judul Agenda" value="{{ $data->title }}" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label><h5>Keterangan</h5></label>
                                                        <textarea name="description" class="ckeditor" id="" cols="30" rows="10">{{ $data->description }}</textarea>
                                                    </div>
                                                    <div class="form-group mb-2">
                                                        <label><h5>Waktu</h5></label>
                                                        <input type="text" name="date" id="fp-date-time" value="{{ $data->date }}" class="form-control flatpickr-date-time" placeholder="YYYY-MM-DD HH:MM" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label><h5>Link (opsional)</h5></label>
                                                        <input type="text" name="url" class="form-control" placeholder="https://example.com" value="{{ $data->url }}">
                                                    </div>
