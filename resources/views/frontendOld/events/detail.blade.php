            ...
            <div class="col-md-8">
                <div class="blog-read">
                    ...
                    <div class="post-text">
                        ...
                        <p>
                            <b>Waktu</b><br>
                            <span>{{ \Carbon\Carbon::parse($data->date_start)->isoFormat('dddd, D MMMM Y') }}</span> - <span>{{ \Carbon\Carbon::parse($data->date_end)->isoFormat('dddd, D MMMM Y') }} </span><br>
                            <span>Pukul</span>&nbsp;&nbsp;<span>{{ \Carbon\Carbon::parse($data->date_start)->format('h:i') }} - {{ \Carbon\Carbon::parse($data->date_end)->format('h:i') }} </span>
                        </p>
                        <p>LINK : {{ $data->link ?? 'tidak tersedia' }}</p>
                        {!! $data->keterangan !!}
